...
import { TBookevent } from '../t-book-event/t-book-event';
...
export const TBookevents: React.FC<TBookevent4Props> = ({
  eventName,
  eventDate,
  location,
  ageLimit,
  ...
  if (showEvent3) {
    return <TBookevent />; // Render TBookevent3 when the state is true
  }
