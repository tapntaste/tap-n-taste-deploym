...
const OrderPlacedScreen = () => {
  return (
    <Box className="w-full bg-primary min-h-screen px-[8%] sm:px-[15%] pt-10 flex justify-center items-center flex-col">
      ...
      <Box className="flex flex-col items-center justify-center max-lg:mt-36 mt-80">
        <h3 className="z-[99] mb-6 rounded-lg text-primary font-semibold text-2xl sm:text-3xl px-4 py-2">
          Order Placed!
        </h3>
        <TButton
